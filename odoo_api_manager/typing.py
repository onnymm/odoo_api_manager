...
_logic_operator = Literal["=", "!=", "in", "not in", "ilike", "not ilike", ">", "<", ">=", "<="]

_values_format = Union[int, str, bool, list[int, str]]

_eval_triplete = Tuple[
    # VSCode jamás sugiere este Literal aunque así debería ser
    odoo_names.MOST_COMMON_FIELDS,
    _logic_operator,
    _values_format
]
...
condition_structure = Union[
    list[
        Union[
            Literal["&", "|"],
            # Se coloca el literal de los campos fuera de la tupla ya que
            # VSCode no hace funcionar el Literal de la primera posición
            # de la tupla
            odoo_names.MOST_COMMON_FIELDS,
            _eval_triplete
        ]
